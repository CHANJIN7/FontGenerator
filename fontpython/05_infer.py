...
parser.add_argument('--model_dir',      dest='model_dir',       type=str,            default=r'/home/dev/fontpython/experiments/checkpoint/experiment_17_batch_8',
                    help='directory that saves the model checkpoints')
# parser.add_argument('--model_dir',      dest='model_dir',       type=str,            default=r'/home/dev/fontpython/baseline/checkpoint/experiment_0_batch_16',
#                     help='directory that saves the model checkpoints')
parser.add_argument('--batch_size',     dest='batch_size',      type=int,            default=1, 
                    help='number of examples in batch')
parser.add_argument('--source_obj',     dest='source_obj',      type=str,            default=r'/home/dev/fontpython/data/package/val.obj', 
                    help='the source images for inference')
parser.add_argument('--embedding_ids',                          type=str,            default='0',
                    help='embeddings involved')
parser.add_argument('--save_dir',                               type=str,            default=r'/home/dev/FONT/experiment_17_batch_8/inferred_result',
...
parser.add_argument('--progress_file',  dest='progress_file',   type=str,            default=r'/home/dev/fontpython/experiments/logs/experiment_17_batch_8/progress', 
